...
exports.triggerPostNotificationCallable = exports.triggerPostNotification = void 0;
const functions = require("firebase-functions/v1");
const admin = require("firebase-admin");
admin.initializeApp();
// This is the function that gets triggered on new post creation
exports.triggerPostNotification = functions.firestore
    ...
    try {
        ...
        for (let i = 0; i < tokens.length; i += batchSize) {
            ...
            const batchMessage = Object.assign(Object.assign({}, message), { tokens: batch });
            try {
...
exports.triggerPostNotificationCallable = functions.https.onCall(async (data, context) => {
    var _a;
    try {
        ...
        */
        ...
        const authorId = data.authorId || (((_a = context.auth) === null || _a === void 0 ? void 0 : _a.uid) || 'anonymous');
